...
(function (module) {
	...
	*/
	...
	const constants = Object.freeze({
		...
		name: 'alaatv',	// Something unique to your OAuth provider in lowercase, like "github", or "nodebb"
		oauth: {
			requestTokenURL: '',
			accessTokenURL: '',
		...
		oauth2: {
			authorizationURL: 'https://alaatv.com/oauth/authorize',
			tokenURL: 'https://alaatv.com/oauth/token',
			clientID: nconf.get('oauth:id'),	// don't change this line
			clientSecret: nconf.get('oauth:secret'),	// don't change this line
		},
		userRoute: nconf.get('oauth:user'),	// This is the address to your app's "user profile" API endpoint (expects JSON)
	});
